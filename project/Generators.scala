...
object Generators extends AutoPlugin {
  ...
  override def projectSettings = Seq(
    ...
    generateAttributeFactories := {
      ...
      """
      val file = (Compile / scalaSource).value / "com" / "concentricsky" / "AttributeFactories.scala"
      val fileContent = Seq(
    ...
    generateElementFactories := {
      ...
      """
      val file = (Compile / scalaSource).value / "com" / "concentricsky" / "ElementFactories.scala"
      val fileContent = Seq(
