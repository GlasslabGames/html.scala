...
object Generators extends AutoPlugin {
  ...
  override def projectSettings = Seq(
    ...
    generateEntityBuilders := {
      ...
      """
      val file = (Compile / scalaSource).value / "com" / "concentricsky" / "binding" / "EntityBuilders.scala"
      val fileContent = Seq(
    ...
    generateAttributeFactories := {
      ...
      val geneatedAst = q"""
        package com.concentricsky.binding {
          ...
          import com.concentricsky.binding.html.NodeBinding.Interpolated.MountPointBuilder
          import com.concentricsky.binding.html.ElementFactory
          import com.concentricsky.binding.html.AttributeFactory
          import com.concentricsky.binding.html.NodeBinding.Constant.AttributeSetter
          import com.concentricsky.binding.html.elementTypes._
      ...
      """
      val file = (Compile / scalaSource).value / "com" / "concentricsky" / "binding" / "AttributeFactories.scala"
      val fileContent = Seq(
    ...
    generateElementFactories := {
      ...
      val geneatedAst = q"""
        package com.concentricsky.binding {
          ...
          import com.concentricsky.binding.html.ElementFactory
          import com.concentricsky.binding.html.elementTypes._
          private[concentricsky] object ElementFactories {
            ..${tagDefs.toList}
          }
        }
      """
      val file = (Compile / scalaSource).value / "com" / "concentricsky" / "binding" / "ElementFactories.scala"
      val fileContent = Seq(
